...
#     # Recursive function to search for 'pe-compute' class
#     def search_pe_compute(subtrees):
...
#                     if act_tag:
#                         if act_tag not in act_dict:
#                             act_dict[act_tag] = []
#                         act_dict[act_tag].append((kernel, count, gated))
#             # Recursively check the inner subtrees
#             if 'subtree' in subtree:
#                 search_pe_compute(subtree['subtree'])

#     search_pe_compute(data.get('architecture', {}).get('subtree', []))
#     return act_dict
...
if __name__ == "__main__":
    ...
    output_filename = 'comp-stat.yaml'
