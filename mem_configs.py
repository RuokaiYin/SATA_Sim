...
def get_args():
    ...
    parser.add_argument('--dram', type=float, default=200, help='dynamic energy for dram')
    parser.add_argument('--sram', type=float, default=7, help='dynamic energy for sram')
    parser.add_argument('--spad', type=float, default=1.176, help='dynamic energy for spad')
